...
export const companies = pgTable(
  "companies",
  {
    ...
    foreignTradingSymbol: varchar("foreign_trading_symbol", { length: 14 }),
...
export const insiders = pgTable(
  "insiders",
  {
    ...
    street1: varchar("street_1", { length: 40 }),
    street2: varchar("street_2", { length: 40 }),
    city: varchar("city", { length: 30 }),
    state: varchar("state", { length: 2 }),
    zipCode: varchar("zip_code", { length: 10 }),
    stateDescription: varchar("state_description", { length: 100 }),
    nonUsAddressFlag: boolean("non_us_address_flag"),
    nonUsStateTerritory: varchar("non_us_state_territory", { length: 40 }),
